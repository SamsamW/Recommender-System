const apiEndpoint = "https://www.outdooractive.com/api/project/api-dev-oa/tours/?key=yourtest-outdoora-ctiveapi&lang=de";

const categoryName = "Offroad"
...
async function fetchPoiData(id) {
  ...
  const hasRestaurant = jsonData.tour.some(item => item.category.name === categoryName);

  if(hasRestaurant)
    return jsonData.tour
  })
